    ...
    \begin{parts}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.8]
                ...
                \foreach \i in {1,...,6}{\draw (1mm,\i) -- + (-2mm,0) node[ left] {\i};}
                % curve
                \draw[very thick, red]  plot[domain= -3.279:1.355, smooth] (\x, 4-3*\x*\x-\x*\x*\x);
...
\begin{questions}
    ...
    \begin{equation*}
        \sin{x}-2\cos{x}=0 \hfill \text{ for } \hfill 0\leq x \leq 360\degree
    \end{equation*}        
    \newpage
...
% Question 1
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        The area of the rectangle is 1260.\\
    ...
    % Question 9
    \question You may use a calculator. Find the size of the obtuse angle at $A$.\\
    \begin{tikzpicture}[scale=0.5]
        \coordinate (A) at (17.32,10);
        \coordinate (B) at (0,0);
    ...
    % Question 10
    \question Each square has an area of 16. Find the area of the circle.\\
    ...
    % Question 14
    \question Show and prove the relation between the gradients of 2 perpendicular lines.\\
    ...
    \begin{tikzpicture}
        ...
        \tkzMarkRightAngle[very thick,draw=black,size=.3](D,A,B);
